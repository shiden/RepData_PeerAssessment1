...
barplot(total_steps, main="Total no/ steps taken ea day", col ="slateblue2", xlab="Date", ylab="steps")
...
plot(average, type="s", main="Average steps taken",xlab = "Minutes", col = "dark blue")
...
barplot(new_total_steps, main="Total no/ steps taken ea day", col ="green", xlab="Date", ylab="steps")
